...
`result.instance.fields.field.shear`; the `Tracer` takes the same split via `al.Tracer(galaxies=[...], 
...
aplt.subplot_fit_interferometer_dirty_images(fit=result.max_log_likelihood_fit)
