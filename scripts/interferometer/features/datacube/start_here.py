...
linear algebra. We use a 14 x 14 `RectangularBilinearAdaptDensity` mesh — small enough to make the prototype iteration
cheap, large enough to capture the emission-line source morphology produced by the simulator.
`RectangularBilinearAdaptDensity` adapts the source-plane pixel density to the lensing magnification map, giving more
