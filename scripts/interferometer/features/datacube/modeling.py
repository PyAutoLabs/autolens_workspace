...
14 x 14 ``RectangularBilinearAdaptDensity`` mesh — small enough to keep the prototype cheap, large enough to capture the
emission-line source morphology produced by the simulator. `RectangularBilinearAdaptDensity` adapts the source-plane
