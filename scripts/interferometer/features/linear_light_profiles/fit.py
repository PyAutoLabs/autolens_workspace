...
inverse-NUFFT of the visibility-plane quantities. This is generally more interpretable to the human eye than
the uv-plane plots above. The dirty model image also has the tracer's critical curves overlaid, derived
automatically from the fit, showing where the lensed source lies relative to the mass model.
"""
