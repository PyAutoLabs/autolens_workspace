...
- `modeling`: Fit the simulated multi-source point dataset jointly using the multi-dataset/factor-graph API (one `AnalysisPoint` per dataset, combined into a `FactorGraphModel`).
