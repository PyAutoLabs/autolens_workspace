...
This script simulates a DSPL, which is used in `imaging/features/advanced/double_source_plane_lens/modeling.py`
...
folder `autolens_workspace/imaging/ double_source_plane_lens`.
"""
