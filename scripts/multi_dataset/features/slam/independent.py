...
- **Multi**: The `autolens_workspace/*/multi_dataset/features` package describes many different ways that multiple datasets
  can be modeled in a single analysis, including the example script `multi_dataset/features/one_by_one/modeling.ipynb` which fits a primary dataset
...
dataset_main_path = Path("dataset", "multi_dataset", "imaging", dataset_name)
...
settings_search = af.SettingsSearch(
    path_prefix=Path("slam", "multi_dataset", "independent"),
