...
- `plot`: How to plot multiple datasets, and fits to multiple datasets, together in combined subplots, for both multi-wavelength CCD imaging and a multi-channel interferometer datacube.
