...
def n_main_from(result) -> int:
    ...
    shear is not a galaxy at all — it lives in the model's `fields` slot.
    """
...
source_0_image_raw = galaxy_image_name_dict["('galaxies', 'source_0')"]
...
dataset_2 = dataset_2.apply_over_sampling(
