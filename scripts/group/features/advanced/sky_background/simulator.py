...
This script simulates ``Imaging`` of a 'group-scale' strong lens where:
 ...
 - The group consists of one main lens galaxy and two extra galaxies with ``SersicSph`` light; the main
   lens has an ``IsothermalSph`` mass profile and the extra galaxies tidally truncated ``dPIEMassSph`` profiles.
