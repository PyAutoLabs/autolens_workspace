"""
__Log Likelihood Function: Group Double Einstein Ring__
...
The only group-specific step is (1). Every other step is identical to the imaging double Einstein ring case.
"""
