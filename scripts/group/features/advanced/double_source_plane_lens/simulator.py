"""
Simulator: Group DSPL
=====================

A double source-plane lens (DSPL) in a group-scale context, where two source galaxies at different redshifts are lensed
...
If any code in this script is unclear, refer to:
 ...
 - `autolens_workspace/scripts/imaging/features/advanced/double_source_plane_lens/simulator.py` — the single-lens
   DSPL simulator.
"""
...
The dataset is written to `dataset/group/double_source_plane_lens/`.
"""
dataset_type = "group"
...
A 200x200 grid at 0.1"/px gives a 20" field of view, large enough to contain a group-scale DSPL
