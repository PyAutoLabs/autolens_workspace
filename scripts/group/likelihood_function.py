...
For the spherical isothermal profile used by the main lens galaxy (the extra galaxies use the tidally
truncated dPIE profile, whose convergence adds core and truncation terms but follows the same recipe):
