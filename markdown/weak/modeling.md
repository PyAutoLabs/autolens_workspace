> ✏️ **This page is auto-generated from [`scripts/weak/modeling.py`](../../scripts/weak/modeling.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/weak/modeling.py) or the [Jupyter notebook](../../notebooks/weak/modeling.ipynb).
...
```
    ...
    2026-07-11 15:56:55,924 - autofit.non_linear.search.abstract_search - INFO - Starting non-linear search with 1 cores.


    2026-07-11 15:56:55,951 - modeling - INFO - The output path of this fit is autolens_workspace/output/weak/simple/modeling/1d8451301c2c1885a1ed9c91314d5ee6


    2026-07-11 15:56:55,954 - modeling - INFO - Outputting pre-fit files (e.g. model.info, visualization).


    2026-07-11 15:56:56,750 - modeling - INFO - Starting new Nautilus non-linear search (no previous samples found).
    ...
    Finished  | 18     | 1        | 4        | 3500     | N/A    | 894   | -114.49  


    2026-07-11 15:57:41,976 - modeling - INFO - Fit Running: Updating results (see output folder).
    ...
    2026-07-11 15:57:55,501 - modeling - INFO - Fit Running: Updating results (see output folder).


    2026-07-11 15:57:56,995 - autofit.non_linear.samples.samples - INFO - Samples with weight less than 1e-10 removed from samples.csv.


    2026-07-11 15:57:57,082 - autofit.non_linear.search.updater - INFO - Creating latent samples by drawing 100 from the PDF.


    2026-07-11 15:58:06,525 - modeling - INFO - Removing search internal folder.


    2026-07-11 15:58:06,528 - modeling - INFO - Removing all files except for .zip file


    2026-07-11 15:58:06,876 - modeling - INFO - Search complete, returning result
...
```
    ...
    Bayesian Evidence                                                               -114.48708828
    Maximum Log Likelihood                                                          -100.80419878
    ...
    ... [28 lines of output truncated] ...
    
    galaxies
        lens
            mass
                centre
                    centre_0                                                        -0.0065 (-0.0102, -0.0026)
                    centre_1                                                        0.0179 (0.0073, 0.0271)
                ell_comps
                    ell_comps_0                                                     0.1233 (0.0662, 0.1849)
                    ell_comps_1                                                     0.0252 (-0.0320, 0.0836)
                einstein_radius                                                     1.5583 (1.4896, 1.6321)
...
```
    ...
    <autofit.mapper.model.ModelInstance object at 0x7f20a0305c40>
