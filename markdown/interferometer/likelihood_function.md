...
![png](likelihood_function_files/likelihood_function_25_1.png)
...
```
    ...
    (10.798931958706433-30.274225322987316j)
...
```
    ...
    /tmp/ipykernel_18904/682768974.py:1: ComplexWarning: Casting complex values to real discards the imaginary part
      noise_normalization = float(np.sum(np.log(2 * np.pi * dataset.noise_map**2.0)))
...
```
    ...
    /tmp/ipykernel_18904/1605092328.py:1: ComplexWarning: Casting complex values to real discards the imaginary part
      figure_of_merit = float(-0.5 * (chi_squared + noise_normalization))
...
![png](likelihood_function_files/likelihood_function_51_1.png)
