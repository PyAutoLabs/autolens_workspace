> ✏️ **This page is auto-generated from [`scripts/group/likelihood_function.py`](../../scripts/group/likelihood_function.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/group/likelihood_function.py) or the [Jupyter notebook](../../notebooks/group/likelihood_function.ipynb).
...
```
    ...
    2026-07-11 15:34:16,735 - autoarray.dataset.imaging.dataset - INFO - IMAGING - Data masked, contains a total of 225 image-pixels
...
![png](likelihood_function_files/likelihood_function_15_0.png)
    ...
    (y,x) coordinates of first ten unmasked image-pixels Grid2D([[ 0.7, -0.7],
           [ 0.7, -0.6],
           [ 0.7, -0.5],
           [ 0.7, -0.4],
           [ 0.7, -0.3],
...
![png](likelihood_function_files/likelihood_function_23_0.png)
    



    
![png](likelihood_function_files/likelihood_function_23_1.png)
    



    
![png](likelihood_function_files/likelihood_function_23_2.png)
...
![png](likelihood_function_files/likelihood_function_31_1.png)
...
![png](likelihood_function_files/likelihood_function_37_0.png)
...
![png](likelihood_function_files/likelihood_function_41_0.png)
...
![png](likelihood_function_files/likelihood_function_47_1.png)
