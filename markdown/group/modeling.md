> ✏️ **This page is auto-generated from [`scripts/group/modeling.py`](../../scripts/group/modeling.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/group/modeling.py) or the [Jupyter notebook](../../notebooks/group/modeling.ipynb).
...
```
    ...
    2026-07-11 15:34:51,802 - autoarray.dataset.imaging.dataset - INFO - IMAGING - Data masked, contains a total of 225 image-pixels
...
```
    ...
    ... [48 lines of output truncated] ...
                ...
                effective_radius                                                    UniformPrior [17], lower_limit = 0.0, upper_limit = 30.0
                sersic_index                                                        UniformPrior [18], lower_limit = 0.8, upper_limit = 5.0
            mass
                einstein_radius                                                     UniformPrior [22], lower_limit = 0.0, upper_limit = 0.5
        1
            redshift                                                                0.5
            bulge
                centre
                    centre_0                                                        GaussianPrior [23], mean = 0.0, sigma = 0.3
                    centre_1                                                        GaussianPrior [24], mean = 0.0, sigma = 0.3
                intensity                                                           LogUniformPrior [25], lower_limit = 1e-06, upper_limit = 1000000.0
                effective_radius                                                    UniformPrior [26], lower_limit = 0.0, upper_limit = 30.0
                sersic_index                                                        UniformPrior [27], lower_limit = 0.8, upper_limit = 5.0
            mass
                einstein_radius                                                     UniformPrior [31], lower_limit = 0.0, upper_limit = 0.5
...
![png](modeling_files/modeling_21_0.png)
...
```
    ...
    model                                                                           Collection (N=21)
        galaxies                                                                    Collection (N=15)
            ...
            lens_0 - source
                bulge                                                               Basis (N=4)
    ... [172 lines of output truncated] ...
                    4
                        sigma                                                       0.014678912944575469
                    5
                        sigma                                                       0.05109370174970344
                    6
                        sigma                                                       0.1778446652245032
                    7
                        sigma                                                       0.6190337334287822
                    8
                        sigma                                                       2.1547048523442527
                    9
                        sigma                                                       7.500000000000001
        0 - 1
            bulge
                profile_list
                    0 - 9
...
```
    ...
    2026-07-11 15:35:01,866 - autofit.non_linear.fitness - INFO - JAX: Applying vmap and jit to likelihood function -- may take a few seconds.


    2026-07-11 15:35:01,867 - autofit.non_linear.fitness - INFO - JAX: vmap and jit applied in 0.00098419189453125 seconds.
...
```
    ...
    2026-07-11 15:50:51,292 - autofit.non_linear.fitness - INFO - Performing quick update of maximum log likelihood fit image and model.results


    2026-07-11 15:50:53,952 - autofit.non_linear.fitness - INFO - Maximum Log Likelihood                                                          -5.48909901
    ...
    2026-07-11 15:50:53,954 - autofit.non_linear.fitness - INFO - Quick update complete in 2.661618709564209 seconds.
    ...
    Finished  | 87     | 1        | 4        | 83800    | N/A    | 3049  | -86.67   
    2026-07-11 15:51:27,171 - modeling - INFO - Fit Running: Updating results (see output folder).


    2026-07-11 15:52:26,093 - autofit.non_linear.plot.plot_util - INFO - Unable to produce corner_anesthetic visual: posterior estimate not yet sufficient. Should succeed in a later update.
    ...
    Finished  | 87     | 1        | 4        | 83800    | N/A    | 3049  | -86.67   
    2026-07-11 15:52:49,081 - modeling - INFO - Fit Running: Updating results (see output folder).


    2026-07-11 15:53:30,308 - autofit.non_linear.samples.samples - INFO - Samples with weight less than 1e-10 removed from samples.csv.


    2026-07-11 15:53:32,419 - autofit.non_linear.search.updater - INFO - Creating latent samples by drawing 100 from the PDF.


    2026-07-11 15:53:32,434 - autofit.non_linear.analysis.latent - INFO - JAX: Applying per-sample jit to latent variables (LATENT_BATCH_MODE='jit') -- may take a few seconds on first sample.


    2026-07-11 15:53:32,437 - autofit.non_linear.analysis.latent - INFO - JAX: jit dispatch applied in 0.0020453929901123047 seconds.


    2026-07-11 15:53:47,495 - autolens.analysis.latent - WARNING - magzero not set on Analysis; 'total_lens_flux_mujy' latent will be NaN. Pass magzero=<value> to AnalysisImaging to enable it, or disable in config/latent.yaml to silence this warning.


    2026-07-11 15:53:47,496 - autolens.analysis.latent - WARNING - magzero not set on Analysis; 'total_lensed_source_flux_mujy' latent will be NaN. Pass magzero=<value> to AnalysisImaging to enable it, or disable in config/latent.yaml to silence this warning.


    2026-07-11 15:53:47,497 - autolens.analysis.latent - WARNING - magzero not set on Analysis; 'total_source_flux_mujy' latent will be NaN. Pass magzero=<value> to AnalysisImaging to enable it, or disable in config/latent.yaml to silence this warning.


    Time to compute latent variables: 55.1171236038208 seconds for 100 samples.


    2026-07-11 15:54:50,100 - autofit.non_linear.plot.plot_util - INFO - Unable to produce corner_anesthetic visual: posterior estimate not yet sufficient. Should succeed in a later update.


    2026-07-11 15:55:36,880 - modeling - INFO - Removing search internal folder.


    2026-07-11 15:55:36,888 - modeling - INFO - Removing all files except for .zip file


    2026-07-11 15:55:38,350 - modeling - INFO - Search complete, returning result
...
```
    ...
    Bayesian Evidence                                                               -86.66674781
    Maximum Log Likelihood                                                          -4.24382080
...
```
    ...
    <autofit.mapper.model.ModelInstance object at 0x7f54f0cf8d10>
...
![png](modeling_files/modeling_35_2.png)
...
```
    ...
    2026-07-11 15:56:03,517 - autofit.non_linear.plot.plot_util - INFO - Unable to produce corner_anesthetic visual: posterior estimate not yet sufficient. Should succeed in a later update.
