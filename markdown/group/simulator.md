> ✏️ **This page is auto-generated from [`scripts/group/simulator.py`](../../scripts/group/simulator.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/group/simulator.py) or the [Jupyter notebook](../../notebooks/group/simulator.ipynb).
...
![png](simulator_files/simulator_29_0.png)
