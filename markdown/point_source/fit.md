> ✏️ **This page is auto-generated from [`scripts/point_source/fit.py`](../../scripts/point_source/fit.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/point_source/fit.py) or the [Jupyter notebook](../../notebooks/point_source/fit.ipynb).
...
```
    ...
    Point Dataset Info:
    name : point_0
    positions : Grid2DIrregular([[-1.0390625 , -1.03832837],
...
```
    ...
    Minimum Distance Between Observed Multiple Images and Model Multiple Images Without Repeats:
    ArrayIrregular([0., 0., 0., 0.])
    Log Likelihood Without Repeats:
...
```
    ...
    Minimum Distance Between Source Plane Centre and Model Source Plane Images After Ray Tracing:
    ArrayIrregular([0.00050107, 0.00037501, 0.00046489, 0.00022876])
    Log Likelihood in the Source Plane:
    0.17651040150996877
