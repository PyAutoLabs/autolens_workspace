...
```
    ...
    2026-07-10 16:13:01,226 - autoarray.dataset.imaging.dataset - INFO - IMAGING - Data noise scaling applied, a total of 256 pixels were scaled to large noise values.



    
![png](fit_files/fit_9_1.png)
...
```
    ...
    2026-07-10 16:13:04,355 - autoarray.dataset.imaging.dataset - INFO - IMAGING - Data masked, contains a total of 2828 image-pixels
...
```
    ...
    Array2D([1.23314313e-10, 2.02729397e-10, 3.16059463e-10, ...,
           2.37964839e-11, 1.69264627e-11, 1.14477513e-11], shape=(2828,))
...
```
    ...
    Array2D([-1.66666668e-02, -2.02729397e-10,  6.66666635e-03, ...,
           -2.33333334e-02, -1.66666667e-02,  6.66666666e-03], shape=(2828,))
    Array2D([-1.00000001e+00, -1.11039464e-08,  3.53553374e-01, ...,
           -1.45960090e+00, -1.00000000e+00,  3.53553390e-01], shape=(2828,))
    Array2D([1.00000001e+00, 1.23297625e-16, 1.24999988e-01, ...,
           2.13043479e+00, 1.00000000e+00, 1.25000000e-01], shape=(2828,))
...
```
    ...
    Array2D([0., 0., 0., ..., 0., 0., 0.], shape=(2828,))
    Array2D([1.23314313e-10, 2.02729397e-10, 3.16059463e-10, ...,
           2.37964839e-11, 1.69264627e-11, 1.14477513e-11], shape=(2828,))
    Array2D([-1.66666668e-02, -2.02729397e-10,  6.66666635e-03, ...,
           -2.33333334e-02, -1.66666667e-02,  6.66666666e-03], shape=(2828,))
    Array2D([-0.01666667,  0.        ,  0.00666667, ..., -0.02333333,
           -0.01666667,  0.00666667], shape=(2828,))
...
```
    ...
    Array2D([[ 3.67222037e-18, -1.63178023e-18, -4.89072199e-18, ...,
            -3.04757015e-18, -3.02078333e-19,  6.13157152e-19],
           [-1.15093093e-17, -6.90626229e-18,  1.57847122e-18, ...,
            -1.29336664e-18,  2.22365106e-18,  9.77446470e-19],
           [-1.55655773e-17, -1.00737751e-17, -3.98604897e-18, ...,
            -5.16001497e-18, -6.09088582e-19,  1.34851874e-18],
           ...,
           [ 7.78597734e-18,  3.39729524e-19, -3.67329281e-18, ...,
             2.80398395e-18,  2.54950369e-18, -1.23049389e-18],
           [ 2.59588228e-18, -6.55989445e-19, -1.49419155e-18, ...,
            -1.27244540e-18, -4.76057287e-18, -6.58422971e-18],
           [ 5.23206178e-19, -2.52790630e-18, -3.86108693e-18, ...,
             3.02669813e-18,  9.85479561e-19, -5.18845153e-18]],
          shape=(100, 100))
