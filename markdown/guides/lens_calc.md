> ✏️ **This page is auto-generated from [`scripts/guides/lens_calc.py`](../../scripts/guides/lens_calc.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/guides/lens_calc.py) or the [Jupyter notebook](../../notebooks/guides/lens_calc.ipynb).
...
![png](lens_calc_files/lens_calc_11_0.png)
...
```
    ...
    Deflection at centre (y, x): [ 1.16178743 -1.16178743]
...
![png](lens_calc_files/lens_calc_19_0.png)
    



    
![png](lens_calc_files/lens_calc_19_1.png)
...
```
    ...
    Hessian_yy at centre: 0.10107165604906025
    Hessian_xx at centre: 0.10107165604886781
...
```
    ...
    Convergence at centre: 0.10107165604896404



    
![png](lens_calc_files/lens_calc_23_1.png)
...
```
    ...
    Shear gamma_2 at centre: 0.10107165604914166
    Shear gamma_1 at centre: -9.622164176548154e-14
    Shear magnitude at centre: 0.10107165604914166
...
```
    ...
    Magnification at centre: 1.2533579214952548



    
![png](lens_calc_files/lens_calc_27_1.png)
...
![png](lens_calc_files/lens_calc_33_0.png)
...
```
    ...
    Einstein radius: 1.5901397863586642 arcsec
...
```
    ...
    Angular Einstein mass: 7.943656951643682 arcsec^2
...
![png](lens_calc_files/lens_calc_39_0.png)
...
![png](lens_calc_files/lens_calc_41_0.png)
