...
![png](galaxies_files/galaxies_5_0.png)
...
```
    ...
    Sersic
    centre: (0.0, 0.0)
    ell_comps: (np.float64(0.05263157894736841), np.float64(3.2227547345982974e-18))
    intensity: 2.0
    effective_radius: 0.6
    sersic_index: 3.0
    Exponential
    centre: (0.0, 0.0)
    ... [23 lines of output truncated] ...
    sersic_index: 3.0
    Exponential
    centre: (0.0, 0.0)
    ell_comps: (np.float64(0.152828012432548), np.float64(0.08823529411764709))
    intensity: 0.1
    effective_radius: 1.6
    sersic_index: 1.0
    Mass Profiles:
...
```
    ...
    0.0012008955213012099
    9.617389028793184e-05
